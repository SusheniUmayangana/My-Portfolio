...
const projects = [
    {
        ...
        longDescription: "Led a 4-person team to build a system that automates GDPR compliance auditing. I specialized in the RAG pipeline using ChromaDB to ensure agents had real-time access to legal frameworks.",
